<?php
  ...
  function evaluateEquation(array $values, int $currentValue, int $desiredValue) : bool {
    ...
    return (evaluateEquation($values, $currentValue * $nextValue, $desiredValue) || evaluateEquation($values, $currentValue + $nextValue, $desiredValue) || evaluateEquation($values, intval("$currentValue$nextValue"), $desiredValue));
  }
?>